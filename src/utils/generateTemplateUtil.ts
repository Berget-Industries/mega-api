const getServerHostUrl = () => {
	...
	return `https://mega-dashboard.${serverType}.berget.industries/auth/jwt/register`;
};
...
export function generateTemplate(token: string) {
    ...
    <div style="font-family: Arial, sans-serif; text-align: center;">
        ...
        <a href="${getServerHostUrl()}?token=${token}" style="display: inline-block; padding: 10px 20px; margin: 20px 0; background-color: #007bff; color: white; text-decoration: none; border-radius: 5px;">Återställ lösenord</a>
